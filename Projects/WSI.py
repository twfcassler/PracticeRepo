# Description: program that generates wins and losses of BYU Women's Soccer during their soccer season using inheritance. 
...
# Parent Class
class Team():
    def __init__(self, tName, wins, losses):
        self.teamName = tName
        self.numWins = wins
...
class soccerTeam(Team):
    ...
    def __init__(self, tName, wins, losses, scored, allowed):
        # Super Constructor
        super().__init__(tName, wins, losses)
